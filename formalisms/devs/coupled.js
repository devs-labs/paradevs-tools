...
exports.grammar = {
    "lex": {
        ...
        "rules": [
            ...
            ["select\\b", "return 'SECTION_SELECT';"],
            ["\\{", "return '{';"],
            ["\\}", "return '}';"],
            ["\\(", "return '(';"],
            ["\\)", "return ')';"],
    ...
    "tokens": "SECTION_NAME SECTION_IN_PORTS SECTION_OUT_PORTS SECTION_SUB_MODELS SECTION_INPUT_CONNECTIONS SECTION_OUTPUT_CONNECTIONS SECTION_INTERNAL_CONNECTIONS SECTION_SELECT " +
    "ID { } ( ) , : ; = < > + -> - * ATOMIC COUPLED R N Z",
    "start": "model",
    "bnf": {
        "model": [["section_name section_in_ports section_out_ports section_sub_models section_input_connections section_output_connections section_internal_connections section_select", "return yy.model"]],
