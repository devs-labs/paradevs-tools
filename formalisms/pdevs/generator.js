...
exports.grammar = {
    "lex": {
        ...
        "rules": [
            ...
            ["translate\\b", "return 'SECTION_TRANSLATE';"],
...
/*    "moduleInclude":
     ...
     "var Model = require('./formalisms/pdevs/model');\n" +
     "var Translator = require('./formalisms/pdevs/translators/paradevs_translator');\n"
     + "var model;"
    , */
    "tokens": "SECTION_NAME SECTION_IN_PORTS SECTION_OUT_PORTS SECTION_PARAMETERS SECTION_STATE SECTION_INIT SECTION_DELTA_INT SECTION_DELTA_EXT SECTION_DELTA_CONF SECTION_TA SECTION_OUTPUT SECTION_TRANSLATE " +
    "; : { } [ ] -> ( ) + - * / , = _ ID INTEGER REAL DEFAULT " +
    "SIN COS TAN COTAN ASIN ACOS ATAN SINH COSH TANH COTANH ASINH ACOSH ATANH " +
    "EXP LN LOG POW, SQRT ABS BAR MAX MIN " +
    "OR AND NOT <> < > <= >=",
    "start": "model",
    "bnf": {
        "model": ["section_name section_parameters section_in_ports section_out_ports section_state section_init section_delta_int section_delta_ext section_delta_conf section_ta section_output section_translate"],
        ...
        "section_translate": [
            [
                "SECTION_TRANSLATE : { }",
                "var translator = new yy.Translator(yy.model); translator.translate(); console.log(translator.code());"
            ]
        ]
    }
};
