...
// public methods
    ...
    this.translate_arithmetic_expression = function (expression) {
        if (expression.arity() === 0) {
            ...
            } else if (expression.to_string() === 'empty_set') {
                _code += String.fromCharCode(0x2205);
            } else {
            ...
            if (expression.name() === "log" || expression.name() === "max" || expression.name() === "min" || expression.name() === "push") {
                _code += expression.name() + '(';
                this.translate_arithmetic_expression(expression.get(1));
                _code += ', ';
